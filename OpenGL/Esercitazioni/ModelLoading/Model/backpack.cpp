// MODIFICHE
// Rotazione dello zaino: righe 233
// Illuminazione directional light, point light e spot light: righe 194, 200, 209 e 278
...
// shader path
char shader_vs_luce[] = "Esercitazioni/ModelLoading/Model/shaderlight.vs";
char shader_fs_luce[] = "Esercitazioni/ModelLoading/Model/shaderlight.fs";
...
int main()
{
    ...
    // -------------------------
    Shader ourShader("Esercitazioni/ModelLoading/Model/shader.vs", "Esercitazioni/ModelLoading/Model/shader.fs");
    Shader lightCubeShader(shader_vs_luce, shader_fs_luce);

    // load models
    // -----------
    Model ourModel("Texture/backpack/backpack.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //model = glm::rotate(model, glm::radians((float)glfwGetTime() * 20.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // rotate around the Y axis
